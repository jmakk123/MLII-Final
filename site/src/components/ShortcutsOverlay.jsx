...
const SHORTCUTS = [
  ...
  { keys: ['3'], label: 'Top Risks' },
  { keys: ['4'], label: 'Backtest' },
  { keys: ['5'], label: 'Overview' },
  { keys: ['6'], label: 'Key Concepts' },
  { keys: ['7'], label: 'Data & Methodology' },
  { keys: ['8'], label: 'Models & Process' },
  { keys: ['9'], label: 'Findings' },
